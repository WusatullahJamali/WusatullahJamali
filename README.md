...
* ⚡ Learning and mastering scalable backend architecture.
* 🌐 Developing responsive, performant web experiences.
* 🤝 Open to collaborate on exciting freelance and development opportunities.
* 📚 Constantly exploring system architecture and clean code practices.
...
| 🎨 Frontend | ⚙️ Backend | 🚀 Professional |
| :--- | :--- | :--- |
| React | Node.js | Full Stack Development |
| Next.js | Express.js | Modern Web Applications |
| Responsive UI | API Development | System Architecture |
| Tailwind CSS | Database Design | Git & GitHub |
| TypeScript | Authentication | UI / UX Principles |
